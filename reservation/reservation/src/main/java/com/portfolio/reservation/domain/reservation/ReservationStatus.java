...
public enum ReservationStatus {
     ...
     * @return
     */
    public static List<ReservationStatus> getImpossibleReservations() {
        return Arrays.asList(
                RESERVE_CONFIRM, CHANGE_REQUEST, CHANGE_CONFIRM, CHANGE_REFUSE, CANCEL_REQUEST,
                CANCEL_REFUSE, RESERVE_COMPLETE);
    }
}
